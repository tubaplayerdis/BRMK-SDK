...
public:
	...
	class UMenuButtonWidget*                      CallFunc_CreateRefreshButton_ReturnValue;          // 0x0038(0x0008)(ZeroConstructor, InstancedReference, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	...
	bool                                          K2Node_Event_bCanRefresh;                          // 0x0048(0x0001)(ZeroConstructor, IsPlainOldData, NoDestructor)
	bool                                          K2Node_Event_bCanJoin;                             // 0x0049(0x0001)(ZeroConstructor, IsPlainOldData, NoDestructor)
};
...
// 0x0001 (0x0001 - 0x0000)
struct SKEL_WBP_ServerBrowser_C_UpdateCanRefresh final
{
public:
	bool                                          bCanRefresh;                                       // 0x0000(0x0001)(BlueprintVisible, BlueprintReadOnly, Parm, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
};
DUMPER7_ASSERTS_SKEL_WBP_ServerBrowser_C_UpdateCanRefresh;

// Function WBP_ServerBrowser.SKEL_WBP_ServerBrowser_C.UpdateCanJoin
// 0x0001 (0x0001 - 0x0000)
struct SKEL_WBP_ServerBrowser_C_UpdateCanJoin final
{
public:
...
DUMPER7_ASSERTS_SKEL_WBP_ServerBrowser_C_UpdateCanJoin;
