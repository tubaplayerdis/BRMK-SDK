...
// BlueprintGeneratedClass BP_ImageCylinder.SKEL_BP_ImageCylinder_C
// 0x0010 (0x0200 - 0x01F0)
class USKEL_BP_ImageCylinder_C final : public UImageBrickStaticInfo
{
public:
...
public:
	static class UClass* StaticClass()
	{
		BP_STATIC_CLASS_IMPL("SKEL_BP_ImageCylinder_C")
	}
	static const class FName& StaticName()
	{
		STATIC_NAME_IMPL(L"SKEL_BP_ImageCylinder_C")
	}
	static class USKEL_BP_ImageCylinder_C* GetDefaultObj()
	{
		return GetDefaultObjImpl<USKEL_BP_ImageCylinder_C>();
	}
};
DUMPER7_ASSERTS_USKEL_BP_ImageCylinder_C;
