...
// BlueprintGeneratedClass BP_Watch_Sequence.SKEL_BP_Watch_Sequence_C
// 0x0028 (0x0350 - 0x0328)
class ASKEL_BP_Watch_Sequence_C final : public AMenuSequence
{
public:
...
public:
	static class UClass* StaticClass()
	{
		BP_STATIC_CLASS_IMPL("SKEL_BP_Watch_Sequence_C")
	}
	static const class FName& StaticName()
	{
		STATIC_NAME_IMPL(L"SKEL_BP_Watch_Sequence_C")
	}
	static class ASKEL_BP_Watch_Sequence_C* GetDefaultObj()
	{
		return GetDefaultObjImpl<ASKEL_BP_Watch_Sequence_C>();
	}
};
DUMPER7_ASSERTS_ASKEL_BP_Watch_Sequence_C;
