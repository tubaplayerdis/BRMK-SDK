...
public:
	...
	TSubclassOf<class ULiveLinkSourceFactory>     Factory;                                           // 0x00A8(0x0008)(Edit, ZeroConstructor, EditConst, IsPlainOldData, NoDestructor, AdvancedDisplay, UObjectWrapper, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	TArray<struct FLiveLinkSourceDebugInfo>       SourceDebugInfos;                                  // 0x00B0(0x0010)(ZeroConstructor, Deprecated, EditorOnly, NativeAccessSpecifierPublic)
