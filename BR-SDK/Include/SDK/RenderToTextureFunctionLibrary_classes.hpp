...
// BlueprintGeneratedClass RenderToTextureFunctionLibrary.SKEL_RenderToTextureFunctionLibrary_C
// 0x0000 (0x0030 - 0x0030)
class USKEL_RenderToTextureFunctionLibrary_C final : public UBlueprintFunctionLibrary
{
public:
	static void Array_to_HLSL_Int_Array(EIntTypes Type, class FString& Variable_Name, TArray<int32>& int_0, TArray<struct FVector2D>& int2, TArray<struct FVector>& int3, TArray<struct FLinearColor>& int4, class UObject* __WorldContext, class FString* String);
	static void Set_Canvas_Material_Scale_and_Position(const struct FVector2D& Size, const struct FVector2D& Position, float Scale, class UObject* __WorldContext, struct FVector2D* Screen_Position, struct FVector2D* Screen_Size);
...
public:
	static class UClass* StaticClass()
	{
		BP_STATIC_CLASS_IMPL("SKEL_RenderToTextureFunctionLibrary_C")
	}
	static const class FName& StaticName()
	{
		STATIC_NAME_IMPL(L"SKEL_RenderToTextureFunctionLibrary_C")
	}
	static class USKEL_RenderToTextureFunctionLibrary_C* GetDefaultObj()
	{
		return GetDefaultObjImpl<USKEL_RenderToTextureFunctionLibrary_C>();
	}
};
DUMPER7_ASSERTS_USKEL_RenderToTextureFunctionLibrary_C;
