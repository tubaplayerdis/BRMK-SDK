...
public:
	...
	struct FHitResult                             CallFunc_K2_SetRelativeRotation_SweepHitResult;    // 0x003C(0x0090)(IsPlainOldData, NoDestructor, ContainsInstancedReference)
	struct FHitResult                             CallFunc_K2_SetRelativeRotation_SweepHitResult_1;  // 0x00CC(0x0090)(IsPlainOldData, NoDestructor, ContainsInstancedReference)
};
...
public:
	...
	struct FHitResult                             CallFunc_K2_SetRelativeLocation_SweepHitResult_1;  // 0x012C(0x0090)(IsPlainOldData, NoDestructor, ContainsInstancedReference)
	struct FHitResult                             CallFunc_K2_SetRelativeLocation_SweepHitResult_2;  // 0x01BC(0x0090)(IsPlainOldData, NoDestructor, ContainsInstancedReference)
...
// 0x000C (0x000C - 0x0000)
struct SKEL_BP_CarElevator_C_OnElevatorStateChanged final
{
public:
	struct FElevatorState                         NewState;                                          // 0x0000(0x000C)(ConstParm, BlueprintVisible, BlueprintReadOnly, Parm, NoDestructor, NativeAccessSpecifierPublic)
};
DUMPER7_ASSERTS_SKEL_BP_CarElevator_C_OnElevatorStateChanged;

// Function BP_CarElevator.SKEL_BP_CarElevator_C.GetInteractionLocation
// 0x0010 (0x0010 - 0x0000)
struct SKEL_BP_CarElevator_C_GetInteractionLocation final
{
public:
	int32                                         Index_0;                                           // 0x0000(0x0004)(BlueprintVisible, BlueprintReadOnly, Parm, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	struct FVector                                ReturnValue;                                       // 0x0004(0x000C)(BlueprintVisible, BlueprintReadOnly, Parm, OutParm, ZeroConstructor, ReturnParm, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
};
DUMPER7_ASSERTS_SKEL_BP_CarElevator_C_GetInteractionLocation;
