...
{
public:
	struct FPointerToUberGraphFrame               UberGraphFrame_SKEL_BP_Paint_Violet_C;             // 0x0398(0x0010)(ZeroConstructor, Transient, DuplicateTransient)
...
public:
	static class UClass* StaticClass()
	{
		BP_STATIC_CLASS_IMPL("SKEL_BP_Paint_Violet_C")
	}
	static const class FName& StaticName()
	{
		STATIC_NAME_IMPL(L"SKEL_BP_Paint_Violet_C")
	}
	static class ASKEL_BP_Paint_Violet_C* GetDefaultObj()
	{
		return GetDefaultObjImpl<ASKEL_BP_Paint_Violet_C>();
	}
};
