...
void USKEL_WBP_TargetMarkerIcon_C::UpdateAmmoType(EAmmoType NewType)
{
	static class UFunction* Func = nullptr;

	if (Func == nullptr)
		Func = Class->GetFunction("SKEL_WBP_TargetMarkerIcon_C", "UpdateAmmoType");

	Params::SKEL_WBP_TargetMarkerIcon_C_UpdateAmmoType Parms{};
...
// (Event, Protected, BlueprintEvent)
// Parameters:
// float                                   NewDist                                                (BlueprintVisible, BlueprintReadOnly, Parm, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)

void USKEL_WBP_TargetMarkerIcon_C::UpdateTargetDistance(float NewDist)
{
	static class UFunction* Func = nullptr;

	if (Func == nullptr)
		Func = Class->GetFunction("SKEL_WBP_TargetMarkerIcon_C", "UpdateTargetDistance");

	Params::SKEL_WBP_TargetMarkerIcon_C_UpdateTargetDistance Parms{};
...
// (Event, Protected, BlueprintEvent)
// Parameters:
// int32                                   NewActionIndex                                         (BlueprintVisible, BlueprintReadOnly, Parm, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)

void USKEL_WBP_TargetMarkerIcon_C::UpdateFireAction(int32 NewActionIndex)
{
	static class UFunction* Func = nullptr;

	if (Func == nullptr)
		Func = Class->GetFunction("SKEL_WBP_TargetMarkerIcon_C", "UpdateFireAction");

	Params::SKEL_WBP_TargetMarkerIcon_C_UpdateFireAction Parms{};
...
// (Event, Protected, BlueprintEvent)
// Parameters:
// bool                                    bNewHasValidTarget                                     (BlueprintVisible, BlueprintReadOnly, Parm, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)

void USKEL_WBP_TargetMarkerIcon_C::UpdateHasValidTarget(bool bNewHasValidTarget)
{
	static class UFunction* Func = nullptr;

	if (Func == nullptr)
		Func = Class->GetFunction("SKEL_WBP_TargetMarkerIcon_C", "UpdateHasValidTarget");

	Params::SKEL_WBP_TargetMarkerIcon_C_UpdateHasValidTarget Parms{};
