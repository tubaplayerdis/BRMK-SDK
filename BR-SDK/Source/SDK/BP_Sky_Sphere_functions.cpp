...
// Function BP_Sky_Sphere.SKEL_BP_Sky_Sphere_C.UpdateSunDirection
// (Public, BlueprintCallable, BlueprintEvent)

void ASKEL_BP_Sky_Sphere_C::UpdateSunDirection()
{
	static class UFunction* Func = nullptr;

	if (Func == nullptr)
		Func = Class->GetFunction("SKEL_BP_Sky_Sphere_C", "UpdateSunDirection");
