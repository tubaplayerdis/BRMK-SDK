...
void USKEL_WaveFoamSimComponent_C::InitializeWaveFoamSim(int32 Res_0, float WorldSize, float Fading, float TimeBias, class AWaterBody* WaterBody, class UShallowWaterSimComponent_C* ShallowWater_0)
{
	static class UFunction* Func = nullptr;

	if (Func == nullptr)
		Func = Class->GetFunction("SKEL_WaveFoamSimComponent_C", "InitializeWaveFoamSim");

	Params::SKEL_WaveFoamSimComponent_C_InitializeWaveFoamSim Parms{};
...
// Function WaveFoamSimComponent.SKEL_WaveFoamSimComponent_C.Create MIDs
// (BlueprintCallable, BlueprintEvent)

void USKEL_WaveFoamSimComponent_C::Create_MIDs()
{
	static class UFunction* Func = nullptr;

	if (Func == nullptr)
		Func = Class->GetFunction("SKEL_WaveFoamSimComponent_C", "Create MIDs");

	UObject::ProcessEvent(Func, nullptr);
}


// Function WaveFoamSimComponent.SKEL_WaveFoamSimComponent_C.Allocate RTs
// (BlueprintCallable, BlueprintEvent)

void USKEL_WaveFoamSimComponent_C::Allocate_RTs()
{
	static class UFunction* Func = nullptr;

	if (Func == nullptr)
		Func = Class->GetFunction("SKEL_WaveFoamSimComponent_C", "Allocate RTs");

	UObject::ProcessEvent(Func, nullptr);
}


// Function WaveFoamSimComponent.SKEL_WaveFoamSimComponent_C.Wave Simulation Step
// (BlueprintCallable, BlueprintEvent)

void USKEL_WaveFoamSimComponent_C::Wave_Simulation_Step()
{
	static class UFunction* Func = nullptr;

	if (Func == nullptr)
		Func = Class->GetFunction("SKEL_WaveFoamSimComponent_C", "Wave Simulation Step");

	UObject::ProcessEvent(Func, nullptr);
}


// Function WaveFoamSimComponent.SKEL_WaveFoamSimComponent_C.Release Foam Sim RTs
// (BlueprintCallable, BlueprintEvent)

void USKEL_WaveFoamSimComponent_C::Release_Foam_Sim_RTs()
{
	static class UFunction* Func = nullptr;

	if (Func == nullptr)
		Func = Class->GetFunction("SKEL_WaveFoamSimComponent_C", "Release Foam Sim RTs");
...
void USKEL_WaveFoamSimComponent_C::Render_Waves_to_RT(TArray<struct FGerstnerWave>& NewParam)
{
	static class UFunction* Func = nullptr;

	if (Func == nullptr)
		Func = Class->GetFunction("SKEL_WaveFoamSimComponent_C", "Render Waves to RT");

	Params::SKEL_WaveFoamSimComponent_C_Render_Waves_to_RT Parms{};
